...
//             endpoints.MapGet("api/mp3/ones/{id}", async (HttpContext context, CancellationToken token) =>
//             {
//                 var controller = context.RequestServices.GetRequiredService<Mp3Controller>();
//                 var id = context.Request.RouteValues["id"]?.ToString();
...
//             endpoints.MapGet("api/mp3/onesay/{id}", async (HttpContext context, CancellationToken token) =>
//             {
//                 var controller = context.RequestServices.GetRequiredService<Mp3Controller>();
//                 var id = context.Request.RouteValues["id"]?.ToString();
