...
namespace MyTts.Config.ServiceConfigurations
{
    ...
    private static bool TestSqlConnection(string connectionString)
    {
        ...
        {
            Console.WriteLine($"SQL Server connection test failed: {ex.Message}"); // Log this in a real app
            return false;
        }
    }
    ...
    private static bool TestPgSqlConnection(string connectionString)
    {
        ...
        {
            Console.WriteLine($"PostgreSQL connection test failed: {ex.Message}"); // Log this in a real app
            return false;
        }
    }
